IF DB_ID('Northwind_Source2') IS NOT NULL
BEGIN
    ALTER DATABASE Northwind_Source2 SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Northwind_Source2;
END
GO

-- Create DB and switch context
CREATE DATABASE Northwind_Source2;
GO
